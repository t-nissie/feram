#!/usr/bin/env gnuplot
# hysteresis.gp
# Time-stamp: <2011-01-26 12:49:13 takeshi>
...
plot 0 title '' w l lt 9,\
     ...
     'hysteresis_d1.hl' using ( $5*100000.0):( $14*c)\
     title 'epit 16{/Symbol \264}16{/Symbol \264}({/Times-Italic l}=4, {/Times-Italic d}=1), {/Times-Italic T} = 175 K' w l lt 2,\
