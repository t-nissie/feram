#!/bin/sh
# anti-000-cooling.sh
# Time-stamp: <2014-05-13 20:30:48 t-nissie>
# Author: Takeshi NISHIMATSU
##
rm -f anti-000-cooling.avg
...
for temperature in `seq $temperature_start $temperature_step $temperature_goal`; do
    ...
    i=`expr $i + 1`
    filename=anti-000-cooling`printf '%.3d' $i`-"$temperature"K
