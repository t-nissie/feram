#!/bin/sh
# zero-000-cooling.sh
# Time-stamp: <2014-05-07 17:52:57 t-nissie>
# Author: Takeshi NISHIMATSU
##
rm -f zero-000-cooling.avg
...
for temperature in `seq $temperature_start $temperature_step $temperature_goal`; do
    ...
    i=`expr $i + 1`
    filename=zero-000-cooling`printf '%.3d' $i`-"$temperature"K
