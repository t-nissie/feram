#!/bin/sh
# sixd-000-heating.sh
# Time-stamp: <2014-05-07 17:49:36 t-nissie>
# Author: Takeshi NISHIMATSU
##
rm -f sixd-000-heating.avg
...
for temperature in `seq $temperature_start $temperature_step $temperature_goal`; do
    ...
    i=`expr $i + 1`
    filename=sixd-000-heating`printf '%.3d' $i`-"$temperature"K
