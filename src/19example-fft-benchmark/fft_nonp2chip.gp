...
set origin 0.0,0.67
plot 'fft_check_nonp2.SR16000.r1975.FFTW.chip.dat'             using 0:9  t 'SR16000'   w lp lw 2 lt 1 pt 1,\
...
set origin 0.0,0.34
plot 'fft_check_nonp2.SR16000.r1975.FFTW.chip.dat'             using 0:12 t 'SR16000'   w lp lw 2 lt 1 pt 1,\
...
set origin 0.0,0.01
plot 'fft_check_nonp2.SR16000.r1975.FFTW.chip.dat'             using 0:15 t 'SR16000'   w lp lw 2 lt 1 pt 1,\
