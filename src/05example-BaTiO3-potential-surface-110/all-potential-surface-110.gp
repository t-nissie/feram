#!/usr/bin/env gnuplot
# Time-stamp: <2008-02-25 10:00:43 takeshi>
...
set xlabel ''
plot \
     'film-L255-D1-110k0.1667.dat' u 1:($3-filmE0) t '(1/6 1/6 0)'   w l lt 8,\
     'film-L255-D1-110k0.1250.dat' u 1:($3-filmE0) t '(1/8 1/8 0)'   w l lt 5,\
     'film-L255-D1-110k0.0833.dat' u 1:($3-filmE0) t '(1/12 1/12 0)' w l lt 4,\
     'film-L255-D1-110k0.0625.dat' u 1:($3-filmE0) t '(1/16 1/16 0)' w l lt 3,\
     'film-L255-D1-110k0.0417.dat' u 1:($3-filmE0) t '(1/24 1/24 0)' w l lt 2,\
