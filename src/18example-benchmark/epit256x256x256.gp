...
t1_E5_2670 = 1500
p_E5_2670  = 0.9
fit f_E5_2670(x) 'epit256x256x256.E5-2670.r1831.dat' using 1:3 via t1_E5_2670,p_E5_2670
...
plot 'epit256x256x256.SR16000.r1831.dat' using 1:3 t "SR16000 (3.83 GHz)\n1 node, 4 CPU, SMT off\nFFTW" w p lt 3 pt 4,\
     ...
     'epit256x256x256.E5-2670.r1831.dat' using 1:3 t "Xeon E5-2670 (2.60 GHz)\n1 node, 2 CPU, HT off\nifort-13.0, MKL"\
                                                                                                        w p lt 2 pt 2,\
...
plot      x t 'ideal' w l lt 5 lw 3,\
          ...
          'epit256x256x256.E5-2670.r1831.dat' using ($1):(t1_E5_2670/$3) t ''         w p  lt 2 pt 2,\
